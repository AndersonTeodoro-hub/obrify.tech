...
// searchKnowledgeSemantic foi extraído para ../_shared/knowledge/semanticSearch.ts
// (reutilizado também pelo eng-silva-search-tool). Comportamento inalterado — a
// chamada abaixo passa 7 argumentos, pelo que o topK usa o default 12.
